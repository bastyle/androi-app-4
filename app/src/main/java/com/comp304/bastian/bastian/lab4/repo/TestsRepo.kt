    ...
    suspend fun addDefaultTests(){
        return withContext(Dispatchers.IO) {
            ...
            if(counter==null || counter ==0){
                ...
                tests.add(TestEntity(patientId = 1, nurseId = "m.perez", department = "Pediatrics", BPH = 2.5f, BPL = 3.5f, temperature = 36.8f))
                tests.add(TestEntity(patientId = 2, nurseId = "e.rodriguez", department = "Emergency Room", BPH = 1.5f, BPL = 2.5f, temperature = 38.8f))
                tests.add(TestEntity(patientId = 3, nurseId = "m.tapia", department = "Cardiology", BPH = 2.8f, BPL = 3.5f, temperature = 39.2f))
                tests.add(TestEntity(patientId = 3, nurseId = "e.rodriguez", department = "Obstetrics", BPH = 1.6f, BPL = 2.5f, temperature = 36.2f))
                tests.add(TestEntity(patientId = 4, nurseId = "m.tapia", department = "Pediatrics", BPH = 1.2f, BPL = 1.3f, temperature = 39.5f))
